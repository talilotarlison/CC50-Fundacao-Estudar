Parece que você quer personalizar o prompt do PowerShell para exibir um texto específico, como `->`. Para fazer isso, você pode alterar o prompt do PowerShell editando a variável `$PROMPT`.
